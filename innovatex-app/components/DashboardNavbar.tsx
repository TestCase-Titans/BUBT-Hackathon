...
export const DashboardNavbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-6 pt-4 pb-2 pointer-events-none flex justify-center">
      <div className="pointer-events-auto w-full max-w-7xl mx-auto flex items-center justify-between
                      /* --- GLOSSY TEXTURE BACKGROUND --- */
                      bg-gradient-to-b from-white/80 to-white/40 dark:from-[#0A3323]/90 dark:to-[#051b12]/80
                      backdrop-blur-2xl backdrop-saturate-150
                      
                      /* --- SHINY BORDER EFFECT --- */
                      border-t border-white/80 dark:border-white/10
                      border-b border-white/20 dark:border-black/20
                      border-x border-white/30 dark:border-white/5
                  ...
                  <NavigationMenu.Link asChild active={isActive}>
                    <Link 
                      ...
                      className={`
                        ...
                        ${isActive 
                          ? 'bg-[#0A3323] text-[#D4FF47] shadow-lg shadow-[#0A3323]/30 ring-1 ring-white/10 dark:bg-[#D4FF47] dark:text-[#0A3323] dark:shadow-[#D4FF47]/20' // Active: High Contrast Gloss
                          : 'text-slate-600 dark:text-slate-300 hover:text-[#0A3323] dark:hover:text-white hover:bg-white/60 dark:hover:bg-white/5' // Inactive
                        }
                      `}
                    >
                      <item.icon 
        ...
        <div className="flex items-center">
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 rounded-full
                       bg-gradient-to-b from-white to-slate-50 dark:from-[#1a4d39] dark:to-[#0A3323]
