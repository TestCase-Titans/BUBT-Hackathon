...
const foodItems = [
  ...
  { name: "Puffed Rice (Muri)", category: ["Grain", "Snack"], typicalExpiryDays: 60, costPerUnit: 90, unit: "kg", imageUrl: "🍿" },
  ...
  { name: "Instant Noodles", category: ["Grain", "Snack"], typicalExpiryDays: 180, costPerUnit: 25, unit: "pack", imageUrl: "🍜" },
  ...
  { name: "Green Chili", category: ["Vegetable", "Spices"], typicalExpiryDays: 7, costPerUnit: 150, unit: "kg", imageUrl: "🌶️" },
  ...
  { name: "Coriander Leaves", category: ["Vegetable", "Spices"], typicalExpiryDays: 3, costPerUnit: 20, unit: "bunch", imageUrl: "🌿" },
  ...
  // --- MEAT PROTEIN ---
  { name: "Broiler Chicken", category: ["Meat Protein"], typicalExpiryDays: 2, costPerUnit: 200, unit: "kg", imageUrl: "🍗" },
  { name: "Sonali Chicken", category: ["Meat Protein"], typicalExpiryDays: 2, costPerUnit: 320, unit: "kg", imageUrl: "🐓" },
  { name: "Beef (Bone-in)", category: ["Meat Protein"], typicalExpiryDays: 3, costPerUnit: 780, unit: "kg", imageUrl: "🥩" },
  { name: "Beef (Boneless)", category: ["Meat Protein"], typicalExpiryDays: 3, costPerUnit: 950, unit: "kg", imageUrl: "🥩" },
  { name: "Mutton", category: ["Meat Protein"], typicalExpiryDays: 3, costPerUnit: 1100, unit: "kg", imageUrl: "🍖" },
  
  // --- FISH PROTEIN ---
  { name: "Rui Fish", category: ["Fish Protein"], typicalExpiryDays: 2, costPerUnit: 450, unit: "kg", imageUrl: "🐟" },
  { name: "Hilsha Fish", category: ["Fish Protein"], typicalExpiryDays: 2, costPerUnit: 1500, unit: "kg", imageUrl: "🐟" },
  { name: "Pangash Fish", category: ["Fish Protein"], typicalExpiryDays: 2, costPerUnit: 180, unit: "kg", imageUrl: "🐟" },
  { name: "Tilapia Fish", category: ["Fish Protein"], typicalExpiryDays: 2, costPerUnit: 220, unit: "kg", imageUrl: "🐟" },
  { name: "Shrimp (Chingri)", category: ["Fish Protein"], typicalExpiryDays: 2, costPerUnit: 800, unit: "kg", imageUrl: "🦐" },
  { name: "Dried Fish (Shutki)", category: ["Fish Protein"], typicalExpiryDays: 180, costPerUnit: 1200, unit: "kg", imageUrl: "🐟" },

  // --- DAIRY / PROTEIN ---
  { name: "Farm Eggs", category: ["Dairy Protein", "Protein"], typicalExpiryDays: 21, costPerUnit: 150, unit: "dozen", imageUrl: "🥚" },
  { name: "Duck Eggs", category: ["Dairy Protein", "Protein"], typicalExpiryDays: 21, costPerUnit: 200, unit: "dozen", imageUrl: "🥚" },
  { name: "Liquid Milk (Packaged)", category: ["Dairy", "Dairy Protein"], typicalExpiryDays: 2, costPerUnit: 90, unit: "L", imageUrl: "🥛" },
  { name: "Powder Milk (Dano/Marks)", category: ["Dairy", "Dairy Protein"], typicalExpiryDays: 365, costPerUnit: 850, unit: "kg", imageUrl: "🥛" },
  { name: "Yogurt (Plain)", category: ["Dairy", "Dairy Protein"], typicalExpiryDays: 7, costPerUnit: 180, unit: "kg", imageUrl: "🥣" },
  { name: "Paneer", category: ["Dairy Protein", "Dairy"], typicalExpiryDays: 10, costPerUnit: 800, unit: "kg", imageUrl: "🧀" },
  { name: "Butter (Local)", category: ["Dairy", "Fats"], typicalExpiryDays: 30, costPerUnit: 400, unit: "block", imageUrl: "🧈" },
  { name: "Ghee", category: ["Dairy", "Fats"], typicalExpiryDays: 365, costPerUnit: 1400, unit: "kg", imageUrl: "🍯" },

  // --- VEGETABLE PROTEIN ---
  { name: "Lentils (Mosur Dal)", category: ["Vegetable Protein", "Grain"], typicalExpiryDays: 180, costPerUnit: 130, unit: "kg", imageUrl: "🥘" },
  { name: "Mug Dal", category: ["Vegetable Protein", "Grain"], typicalExpiryDays: 180, costPerUnit: 160, unit: "kg", imageUrl: "🥘" },
  { name: "Chickpeas (Chola)", category: ["Vegetable Protein", "Grain"], typicalExpiryDays: 365, costPerUnit: 110, unit: "kg", imageUrl: "🥣" },

  // --- SPICES, FATS & OTHERS ---
  { name: "Soybean Oil", category: ["Fats", "General"], typicalExpiryDays: 365, costPerUnit: 165, unit: "L", imageUrl: "🛢️" },
  { name: "Mustard Oil", category: ["Fats", "General"], typicalExpiryDays: 365, costPerUnit: 250, unit: "L", imageUrl: "🟡" },
  { name: "Olive Oil", category: ["Fats", "General"], typicalExpiryDays: 540, costPerUnit: 1200, unit: "L", imageUrl: "🫒" },
  ...
  { name: "Turmeric Powder", category: ["Spices"], typicalExpiryDays: 365, costPerUnit: 300, unit: "kg", imageUrl: "🟠" },
  { name: "Chili Powder", category: ["Spices"], typicalExpiryDays: 365, costPerUnit: 450, unit: "kg", imageUrl: "🌶️" },
  { name: "Cumin Seeds", category: ["Spices"], typicalExpiryDays: 365, costPerUnit: 1200, unit: "kg", imageUrl: "🟤" },
  ...
  { name: "Chanachur", category: ["Snack"], typicalExpiryDays: 90, costPerUnit: 150, unit: "pack", imageUrl: "🥜" },
  { name: "Biscuits (Digestive)", category: ["Snack"], typicalExpiryDays: 180, costPerUnit: 120, unit: "pack", imageUrl: "🍪" },
  { name: "Toast Biscuit", category: ["Snack"], typicalExpiryDays: 60, costPerUnit: 80, unit: "pack", imageUrl: "🍞" },
];
