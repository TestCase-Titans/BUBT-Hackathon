...
import { Leaf, Droplet, Sun, Wind, ArrowRight, Plus, AlertCircle } from 'lucide-react';
    ...
    <PageWrapper>
       <div className="pb-24 lg:pb-8 pt-8 px-6 lg:px-12 max-w-7xl mx-auto">
         <header className="flex justify-between items-end mb-8">
            <div>
              <h2 className="text-3xl lg:text-4xl font-serif text-[#0A3323]">Good Morning,</h2>
            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                >
                    ...
                    <div>
                        ...
                        <h3 className="text-4xl lg:text-5xl font-serif mb-2">Excellent</h3>
                        <p className="text-sm text-gray-400 max-w-[200px] lg:max-w-md">You are in the top 10% of sustainable households in your area.</p>
                    </div>
                    <div className="w-24 h-24 lg:w-32 lg:h-32 rounded-full border-4 border-[#D4FF47]/30 flex items-center justify-center relative flex-shrink-0">
                        <div className="absolute inset-0 border-4 border-[#D4FF47] rounded-full border-l-transparent rotate-45"></div>
                        <span className="text-2xl lg:text-4xl font-bold text-[#D4FF47]">92</span>
                    </div>
                    </div>
                ...
                <div className="grid grid-cols-3 gap-3 lg:gap-6">
                    ...
                    <motion.div 
                        ...
                        className={`${THEME.glass} p-4 lg:p-6 rounded-2xl flex flex-col items-center justify-center text-center hover:bg-white transition-colors`}
                    >
                        <stat.icon size={24} className="text-[#0A3323] mb-2 lg:mb-3" />
                        <span className="text-lg lg:text-2xl font-bold text-[#0A3323]">{stat.value}</span>
                        <span className="text-[10px] lg:text-xs text-gray-500 uppercase font-bold">{stat.label}</span>
                    </motion.div>
                    ))}
                </div>
            </div>
            ...
            <div className="lg:col-span-1 space-y-6">
                <div className="bg-[#E8F5E9] p-6 rounded-3xl border border-[#0A3323]/5">
                    ...
                    <p className="text-sm text-[#0A3323]/80 leading-relaxed mb-4">
                        Storing milk on the door makes it spoil faster. Keep it on the middle shelf.
                    </p>
                </div>
