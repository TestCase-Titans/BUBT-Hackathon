...
export default function MealPlanPage() {
  ...
  const handleExport = () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `eco-loop-plan-${new Date().toISOString().split('T')[0]}.json`;
    ...
    <PageWrapper>
      <div className="pb-24 lg:pb-12 pt-8 px-6 lg:px-12 max-w-7xl mx-auto min-h-screen flex flex-col">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-6">
          <div>
            ...
            <p className="text-gray-500 max-w-md">
              Smart meal planning that prioritizes your expiring ingredients and budget.
            </p>
          </div>
            ...
            >
              ...
              {loading ? (
                ...
                <>
                  ...
                  <span>{planData ? "Regenerate Menu" : "Create Meal Plan"}</span>
                </>
              )}
            </button>
          </div>
        ...
        {!planData && !loading && (
           ...
           >
              <div className="w-32 h-32 bg-[#F3F6F4] rounded-full flex items-center justify-center mb-8 relative group cursor-pointer" onClick={generatePlan}>
              ...
              <h3 className="text-2xl font-serif font-bold text-[#0A3323] mb-3">What&apos;s for Dinner?</h3>
              <p className="text-gray-400 max-w-md mb-8 leading-relaxed">
                Our AI Chef analyzes your inventory to create a zero-waste, budget-friendly meal plan for the week.
              </p>
              <button onClick={generatePlan} className="text-[#0A3323] font-bold flex items-center gap-2 hover:gap-4 transition-all group">
        ...
        {loading && (
           <div className="flex-1 flex flex-col items-center justify-center min-h-[400px] text-center">
              ...
              <h3 className="text-2xl font-serif text-[#0A3323] mb-2">The AI is Cooking...</h3>
              <p className="text-gray-500">Checking expiry dates & finding local recipes.</p>
           </div>
        )}
        ...
        {planData && !loading && (
          ...
          >
            ...
            <div className="lg:col-span-8 space-y-6">
               ...
               {/* Impact Card */}
               <motion.div variants={item} className="bg-gradient-to-br from-[#0A3323] to-[#0F4D34] p-8 rounded-[2rem] text-[#F3F6F4] shadow-xl relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h4 className="font-bold text-lg tracking-wide">Sustainability Impact</h4>
                    </div>
                    ...
                    >
                       <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-50">
                          <div className="w-10 h-10 rounded-full bg-[#F3F6F4] flex items-center justify-center group-hover:bg-[#D4FF47] transition-colors">
                            <Calendar size={18} className="text-gray-400 group-hover:text-[#0A3323]" />
                          </div>
               ...
               <div className="bg-white p-6 rounded-[2rem] shadow-lg border border-gray-100 sticky top-24">
                  <div className="flex items-center justify-between mb-8">
                     <h3 className="text-xl font-serif font-bold text-[#0A3323] flex items-center gap-2">
                        <ShoppingBag size={20} className="text-[#D4FF47] fill-[#0A3323]" /> 
                        Shopping List
                     </h3>
                  </div>
                  ...
                  <div className="space-y-0 relative">
                     ...
                     {planData.shoppingList.map((item: any, i: number) => (
                        ...
                        >
                           <div className="flex items-center gap-3">
                              ...
                              <span className="text-sm font-medium text-gray-700 group-hover:text-[#0A3323]">{item.item}</span>
                           </div>
                     ...
                     <div className="mt-6 pt-4 border-t-2 border-dashed border-gray-200 flex justify-between items-center">
                        <span className="text-sm font-bold text-gray-500 uppercase tracking-wider">Est. Total</span>
                        <span className="text-2xl font-serif font-bold text-[#0A3323]">
                           ৳{planData.shoppingList.reduce((acc:any, curr:any) => acc + curr.estimatedCost, 0)}
                        </span>
                     </div>
                  </div>
