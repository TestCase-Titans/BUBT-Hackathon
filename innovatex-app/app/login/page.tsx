...
import { Wheat, AlertCircle, ArrowLeft } from "lucide-react";
        ...
        <div className="relative z-10 text-center p-8">
          ...
          >
            <div className="w-24 h-24 mx-auto bg-[#D4FF47] rounded-full flex items-center justify-center mb-6 shadow-[0_0_40px_rgba(212,255,71,0.4)]">
              <Wheat size={48} className="text-[#0A3323]" />
            </div>
            <h1 className="text-5xl font-serif text-[#F3F6F4] mb-2">
              Eco-Loop
            </h1>
            <p className="text-[#D4FF47] font-mono text-sm tracking-widest uppercase">
        ...
        >
          ...
          <p className="text-gray-500 mb-8">
            {isRegister
              ...
              : "Log in to manage your sustainable pantry."}
          </p>
